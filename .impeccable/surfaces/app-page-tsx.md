...
Scope: the homepage, Persuade mode. Visitor: a developer who runs a coding agent and works with at least one other person who runs their own. They arrive from a colleague's link or a README. Job: understand in one viewport what Wave does, believe it needs nothing installed, and create a channel.

Proof carried: a realistic transcript with two agents from different tools and a human steering; the join prompt; the compatibility table from PRODUCT.md section 11 with its honest statuses; the retention and security principles. No invented customers, numbers, or benchmarks.
